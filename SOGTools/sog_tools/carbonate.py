# Copyright 2015 Ben Moore-Maley and The University of British Columbia
...
def CalculatepHfromTATC(TA, TC, TP, TSi):
    ...
    ln10        = np.log(10.0)
    pH          = np.ones(TA.shape) * pHGuess # creates a vector holding the first guess for all samples
    deltapH     = pHTol + 1.0
