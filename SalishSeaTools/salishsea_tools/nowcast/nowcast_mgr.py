    ...
    * :py:attr:`config`
    ...
    def after_actions(self):
        ...
        return {
            ...
            # 'set_ssh_config': self._after_set_ssh_config,
            # 'set_mpi_hosts': self._after_set_mpi_hosts,
            # 'mount_sshfs': self._after_mount_sshfs,
    ...
    def _load_checklist(self):
        ...
        try:
            ...
            self.logger.warning('checklist load failed: {.message}'.format(e))
