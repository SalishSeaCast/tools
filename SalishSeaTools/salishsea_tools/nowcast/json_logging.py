"""A quick and dirty back-port to Python 2.7 of the driftwood.formatters.dict
and driftwood.formatters.json modules from the Hurricane Labs driftwood package
<https://github.com/HurricaneLabs/driftwood>.

The driftwood code has an MIT license.

This is a stop-gap measure until we get nowcat ported to Python 3,
at which point we will use the driftwood package properly.
In the meantime, horray for open source!
"""
...
class DictFormatter(logging.Formatter):
    ...
    default_regular_attrs = ["name","message","levelno","levelname","pathname","filename","module","lineno",
    ...
    def __init__(self, regular_attrs=None, extra_attrs=None,
                 preserve_order=False, specific_order=None, *args, **kwargs):
        """
