...
prop_dict['jdf'] = {
    'SanJuan': {
        'prop': 0.33 * CAFlux, 'i': 401, 'j': 62, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Gordon': {
        'prop': 0.14 * CAFlux, 'i': 404, 'j': 62, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Loss': {
        'prop': 0.05 * CAFlux, 'i': 376, 'j': 72, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Jordan': {
        'prop': 0.05 * CAFlux, 'i': 349, 'j': 96, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Muir': {
        'prop': 0.05 * CAFlux, 'i': 326, 'j': 120, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Tugwell': {
        'prop': 0.05 * CAFlux, 'i': 325, 'j': 121, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Sooke': {
        'prop': 0.33 * CAFlux, 'i': 315, 'j': 144, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Elwha': {
    ...
    'DungenessMatriotti': {
        'prop': 0.60 * 0.30 * USFlux + 0.60 * 0.02 * USFlux, 'i': 233, 'j': 202, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Coville': {
    ...
    'Field': {
        'prop': 0.40 * 0.05 * USFlux, 'i': 281, 'j': 101, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Lyre': {
        'prop': 0.40 * 0.20 * USFlux, 'i': 283, 'j': 99, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'EastWestTwin': {
        'prop': 0.40 * 0.05 * USFlux, 'i': 293, 'j': 82, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Deep': {
        'prop': 0.40 * 0.05 * USFlux, 'i': 299, 'j': 73, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Pysht': {
        'prop': 0.40 * 0.10 * USFlux, 'i': 311, 'j': 65, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Clallom': {
    ...
    'Sekiu': {
        'prop': 0.40 * 0.10 * USFlux, 'i': 350, 'j': 31, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Sail': {
...
prop_dict['puget'] = {
    ...
    'Torboo': {
        'prop': 0.05 * WRIA17, 'i': 148, 'j': 208, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'LittleBigQuilcene': {
        'prop': 0.35 * WRIA17, 'i': 145, 'j': 196, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Dosewalips': {
        'prop': 0.20 * WRIA16, 'i': 123, 'j': 177, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Duckabush': {
        'prop': 0.14 * WRIA16, 'i': 118, 'j': 167, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Fulton': {
    ...
    'Skokomish': {
        'prop': 0.40 * WRIA16, 'i': 76, 'j': 102, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Rendsland': {
    ...
    'Mission': {
        'prop': 0.05 * WRIA15, 'i': 73, 'j': 146, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Union': {
        'prop': 0.10 * WRIA15, 'i': 72, 'j': 147, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Coulter': {
        'prop': 0.05 * WRIA15, 'i': 58, 'j': 150, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Minter': {
    ...
    'Dewatta': {
        'prop': 0.05 * WRIA15, 'i': 94, 'j': 123, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Sherwood': {
        'prop': 0.15 * WRIA14, 'i': 57, 'j': 149, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'DeerJohnsGoldboroughMill': {
        'prop': 0.50 * WRIA14, 'i': 34, 'j': 113, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Skookum': {
        'prop': 0.10 * WRIA14, 'i':29, 'j': 95, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'KennedySchneider': {
        'prop': 0.15 * WRIA14, 'i': 23, 'j': 89, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'PerryMcClane': {
        'prop': 0.10 * WRIA14 + 0.10 * WRIA13, 'i': 13, 'j': 91, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Deschutes': {
        'prop': 0.70 * WRIA13, 'i': 4, 'j': 100, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Woodward': {
        'prop': 0.10 * WRIA13, 'i': 13, 'j': 120, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Woodland': {
        'prop': 0.10 * WRIA13, 'i': 14, 'j': 119, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Chambers': {
...
prop_dict['skagit'] = {
    'Skagit1': {
        'prop': 0.5 * (WRIA4 * 1.0 + WRIA3 * 0.75), 'i': 213, 'j': 313, 'di': 1, 'dj': 1, 'depth': 2,
            },
    'Skagit2': {
        'prop': 0.5 * (WRIA4 * 1.0 + WRIA3 * 0.75), 'i': 229, 'j': 310, 'di': 1, 'dj': 1, 'depth': 2,
            },
    'Samish': {
        'prop': WRIA3 * 0.20, 'i': 271, 'j': 342, 'di': 1, 'dj': 1, 'depth': 3,
            },
    'JoeLeary': {
        'prop': WRIA3 * 0.05, 'i': 257, 'j': 331, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Stillaguamish1': {
        'prop': 0.7 * WRIA5 * 1.0, 'i': 183, 'j': 308, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Stillaguamish2': {
        'prop': 0.1 * WRIA5 * 1.0, 'i': 188, 'j': 306, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Stillaguamish3': {
        'prop': 0.2 * WRIA5 * 1.0, 'i': 205, 'j': 307, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'SnohomishAllenQuilceda': {
        'prop': WRIA7 * 0.98, 'i': 138, 'j': 311, 'di': 1, 'dj': 1, 'depth': 2,
            },
    'Tulalip': {
        'prop': WRIA7 * 0.01, 'i': 155, 'j': 310, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Mission': {
        'prop': WRIA7 * 0.01, 'i': 154, 'j': 311, 'di': 1, 'dj': 1, 'depth': 1,
            }}
...
prop_dict['fraser'] = {
    'Serpentine': {
        'prop': 116 * Nooksack_cor, 'i': 390, 'j': 350,
        'di': 1, 'dj': 1, 'depth': 1
        },
    'Nicomekl': {
        'prop': 149 * Nooksack_cor, 'i': 388, 'j': 350,
        'di': 1, 'dj': 1, 'depth': 1
        },
    'LittleCampbell': {
        'prop': 60 * Nooksack_cor, 'i': 372, 'j': 357,
        'di': 1, 'dj': 1, 'depth': 1
        },
    'Colebrook': {
        'prop': 31 * Nooksack_cor, 'i': 390, 'j': 346,
        'di': 1, 'dj': 1, 'depth': 1
        },
    'Dakota': {
        'prop': WRIA1 * 0.06, 'i': 365, 'j': 357,
        'di': 1, 'dj': 1, 'depth': 1,
            },
    'Terrel': {
        'prop': WRIA1 * 0.04, 'i': 353, 'j': 349,
        'di': 1, 'dj': 1, 'depth': 1,
            },
    'Nooksack': {
...
prop_dict['evi_n'] = {
    ...
    'SalmonSayward': {
        'prop': (1210 + 14) / totalarea, 'i': 865, 'j': 64, 'di': 1, 'dj': 1, 'depth': 1},
    'Kelsey': {
...
prop_dict['jervis'] = {
    ...
    'Loquilts': {
        'prop': Jervis * 0.04, 'i': 674, 'j': 346, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Potato': {
...
prop_dict['evi_s'] = {
    'Cowichan1': {
        'prop': 0.5*0.22, 'i': 383, 'j': 201, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Cowichan2': {
        'prop': 0.5*0.22, 'i': 382, 'j': 200, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Chemanius1': {
        'prop': 0.5 * 0.13, 'i': 415, 'j': 213, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Chemanius2': {
        'prop': 0.5 * 0.13, 'i': 418, 'j': 212, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Nanaimo1': {
        'prop': 0.67 * 0.14, 'i': 479, 'j': 210, 'di': 1, 'dj': 2, 'depth': 1,
            },
    'Nanaimo2': {
        'prop': 0.33 * 0.14, 'i': 478, 'j': 211, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'NorNanaimo': {
    ...
    'Nanoose': {
        'prop': 0.02, 'i': 520, 'j': 183, 'di': 1, 'dj': 1, 'depth': 1,
            },
    'Englishman': {
