...
"""Unit tests for Salish Sea NEMO nowcast upload_all_files worker.
"""
...
@pytest.fixture
def worker_module():
    from salishsea_tools.nowcast.workers import upload_all_files
    return upload_all_files
...
class TestMain:
    ...
    def test_run_worker(self, m_worker, worker_module):
        ...
        assert args == (
            worker_module.upload_all_files,
...
class TestSuccess:
    ...
    def test_success_log_info(self, worker_module):
        parsed_args = Mock(host_name='west.cloud-nowcast')
    ...
    def test_success_msg_type(self, worker_module):
        parsed_args = Mock(host_name='orcinus-nowcast')
