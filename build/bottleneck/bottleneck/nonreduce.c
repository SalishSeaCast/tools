...
#define __PYX_HAVE__bottleneck__nonreduce
#define __PYX_HAVE_API__bottleneck__nonreduce
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
struct __pyx_opt_args_10bottleneck_9nonreduce_nonreducer;

/* "bottleneck/nonreduce.pyx":184
 * # nonreduce -----------------------------------------------------------------
 * 
 ...
 *                          int, npy_intp*,
 */
typedef PyArrayObject *(*__pyx_t_10bottleneck_9nonreduce_nr_t)(PyArrayObject *, PyArrayIterObject *, Py_ssize_t, Py_ssize_t, int, npy_intp *, double, double);

/* "bottleneck/nonreduce.pyx":190
 * 
 * 
...
/* Module declarations from 'bottleneck.nonreduce' */
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_replace_float64(PyArrayObject *, PyArrayIterObject *, Py_ssize_t, Py_ssize_t, int, npy_intp *, double, double); /*proto*/
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_replace_float32(PyArrayObject *, PyArrayIterObject *, Py_ssize_t, Py_ssize_t, int, npy_intp *, double, double); /*proto*/
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_replace_int64(PyArrayObject *, PyArrayIterObject *, Py_ssize_t, Py_ssize_t, int, npy_intp *, double, double); /*proto*/
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_replace_int32(PyArrayObject *, PyArrayIterObject *, Py_ssize_t, Py_ssize_t, int, npy_intp *, double, double); /*proto*/
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_nonreducer(PyObject *, __pyx_t_10bottleneck_9nonreduce_nr_t, __pyx_t_10bottleneck_9nonreduce_nr_t, __pyx_t_10bottleneck_9nonreduce_nr_t, __pyx_t_10bottleneck_9nonreduce_nr_t, double, double, struct __pyx_opt_args_10bottleneck_9nonreduce_nonreducer *__pyx_optional_args); /*proto*/
#define __Pyx_MODULE_NAME "bottleneck.nonreduce"
int __pyx_module_is_main_bottleneck__nonreduce = 0;

/* Implementation of 'bottleneck.nonreduce' */
...
static const char __pyx_k_replace_line_36[] = "replace (line 36)";
static const char __pyx_k_bottleneck_nonreduce[] = "bottleneck.nonreduce";
static const char __pyx_k_bottleneck_slow_nonreduce[] = "bottleneck.slow.nonreduce";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Cannot_safely_cast_new_to_int[] = "Cannot safely cast `new` to int.";
static const char __pyx_k_Cannot_safely_cast_old_to_int[] = "Cannot safely cast `old` to int.";
static const char __pyx_k_Replace_inplace_given_scalar_va[] = "\n    Replace (inplace) given scalar values of an array with new values.\n\n    The equivalent numpy function:\n\n        arr[arr==old] = new\n\n    Or in the case where old=np.nan:\n\n        arr[np.isnan(old)] = new\n\n    Parameters\n    ----------\n    arr : numpy.ndarray\n        The input array, which is also the output array since this functions\n        works inplace.\n    old : scalar\n        All elements in `arr` with this value will be replaced by `new`.\n    new : scalar\n        All elements in `arr` with a value of `old` will be replaced by `new`.\n\n    Returns\n    -------\n    None, the operation is inplace.\n\n    Examples\n    --------\n    Replace zero with 3 (note that the input array is modified):\n\n    >>> a = np.array([1, 2, 0])\n    >>> bn.replace(a, 0, 3)\n    >>> a\n    array([1, 2, 3])\n\n    Replace np.nan with 0:\n\n    >>> a = np.array([1, 2, np.nan])\n    >>> bn.replace(a, np.nan, 0)\n    >>> a\n    array([ 1.,  2.,  0.])\n\n    ";
static const char __pyx_k_devel_bottleneck_bottleneck_non[] = "/devel/bottleneck/bottleneck/nonreduce.pyx";
...
static PyObject *__pyx_kp_u_Replace_inplace_given_scalar_va;
static PyObject *__pyx_n_s_RuntimeError;
static PyObject *__pyx_n_s_TypeError;
static PyObject *__pyx_n_s_ValueError;
static PyObject *__pyx_n_s__11;
static PyObject *__pyx_n_s_arr;
static PyObject *__pyx_n_s_bottleneck_nonreduce;
static PyObject *__pyx_n_s_bottleneck_slow_nonreduce;
...
static PyObject *__pyx_kp_u_replace_line_36;
static PyObject *__pyx_n_s_slow;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_pf_10bottleneck_9nonreduce_replace(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_arr, double __pyx_v_old, double __pyx_v_new); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_10bottleneck_9nonreduce_1replace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10bottleneck_9nonreduce_replace[] = "replace(arr, double old, double new)\n\n    Replace (inplace) given scalar values of an array with new values.\n\n    The equivalent numpy function:\n\n        arr[arr==old] = new\n\n    Or in the case where old=np.nan:\n\n        arr[np.isnan(old)] = new\n\n    Parameters\n    ----------\n    arr : numpy.ndarray\n        The input array, which is also the output array since this functions\n        works inplace.\n    old : scalar\n        All elements in `arr` with this value will be replaced by `new`.\n    new : scalar\n        All elements in `arr` with a value of `old` will be replaced by `new`.\n\n    Returns\n    -------\n    None, the operation is inplace.\n\n    Examples\n    --------\n    Replace zero with 3 (note that the input array is modified):\n\n    >>> a = np.array([1, 2, 0])\n    >>> bn.replace(a, 0, 3)\n    >>> a\n    array([1, 2, 3])\n\n    Replace np.nan with 0:\n\n    >>> a = np.array([1, 2, np.nan])\n    >>> bn.replace(a, np.nan, 0)\n    >>> a\n    array([ 1.,  2.,  0.])\n\n    ";
static PyMethodDef __pyx_mdef_10bottleneck_9nonreduce_1replace = {"replace", (PyCFunction)__pyx_pw_10bottleneck_9nonreduce_1replace, METH_VARARGS|METH_KEYWORDS, __pyx_doc_10bottleneck_9nonreduce_replace};
static PyObject *__pyx_pw_10bottleneck_9nonreduce_1replace(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("replace (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_old)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("replace", 1, 3, 3, 1); __PYX_ERR(0, 36, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_new)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("replace", 1, 3, 3, 2); __PYX_ERR(0, 36, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "replace") < 0)) __PYX_ERR(0, 36, __pyx_L3_error)
      }
    ...
    __pyx_v_old = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_old == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_new = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_new == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("replace", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 36, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("bottleneck.nonreduce.replace", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10bottleneck_9nonreduce_replace(__pyx_self, __pyx_v_arr, __pyx_v_old, __pyx_v_new);
...
static PyObject *__pyx_pf_10bottleneck_9nonreduce_replace(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_arr, double __pyx_v_old, double __pyx_v_new) {
  ...
  struct __pyx_opt_args_10bottleneck_9nonreduce_nonreducer __pyx_t_5;
  int __pyx_t_6;
 ...
 */
      __pyx_t_5.__pyx_n = 1;
      __pyx_t_5.inplace = 1;
      __pyx_t_4 = ((PyObject *)__pyx_f_10bottleneck_9nonreduce_nonreducer(__pyx_v_arr, __pyx_f_10bottleneck_9nonreduce_replace_float64, __pyx_f_10bottleneck_9nonreduce_replace_float32, __pyx_f_10bottleneck_9nonreduce_replace_int64, __pyx_f_10bottleneck_9nonreduce_replace_int32, __pyx_v_old, __pyx_v_new, &__pyx_t_5)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 80, __pyx_L3_error)
 ...
 */
    ...
    if (__pyx_t_6) {
      __Pyx_AddTraceback("bottleneck.nonreduce.replace", __pyx_clineno, __pyx_lineno, __pyx_filename);
      if (__Pyx_GetException(&__pyx_t_4, &__pyx_t_7, &__pyx_t_8) < 0) __PYX_ERR(0, 88, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_GOTREF(__pyx_t_8);

      /* "bottleneck/nonreduce.pyx":89
 *                    1)
 *     except TypeError:
 *         slow.replace(arr, old, new)             # <<<<<<<<<<<<<<
 * 
 * 
 */
      __pyx_t_10 = __Pyx_GetModuleGlobalName(__pyx_n_s_slow); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 89, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_11 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_replace); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 89, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_11);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = PyFloat_FromDouble(__pyx_v_old); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 89, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_12 = PyFloat_FromDouble(__pyx_v_new); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 89, __pyx_L5_except_error)
      ...
      __pyx_t_15 = PyTuple_New(3+__pyx_t_14); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 89, __pyx_L5_except_error)
      ...
      __pyx_t_10 = 0;
      __pyx_t_12 = 0;
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_11, __pyx_t_15, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 89, __pyx_L5_except_error)
...
/* "bottleneck/nonreduce.pyx":92
 * 
 * 
 * cdef ndarray replace_float64(ndarray a, flatiter ita,             # <<<<<<<<<<<<<<
 *                             Py_ssize_t stride, Py_ssize_t length,
 *                             int a_ndim, npy_intp* y_dims,
 */

static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_replace_float64(PyArrayObject *__pyx_v_a, PyArrayIterObject *__pyx_v_ita, Py_ssize_t __pyx_v_stride, Py_ssize_t __pyx_v_length, CYTHON_UNUSED int __pyx_v_a_ndim, CYTHON_UNUSED npy_intp *__pyx_v_y_dims, double __pyx_v_old, double __pyx_v_new) {
 ...
 */
  ...
  /* "bottleneck/nonreduce.pyx":113
 *                         (<float64_t*>((<char*>pid(ita)) + i * stride))[0] = new
 *                 PyArray_ITER_NEXT(ita)
 *     return a             # <<<<<<<<<<<<<<
 * 
 * cdef ndarray replace_float32(ndarray a, flatiter ita,
 */
...
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_replace_float32(PyArrayObject *__pyx_v_a, PyArrayIterObject *__pyx_v_ita, Py_ssize_t __pyx_v_stride, Py_ssize_t __pyx_v_length, CYTHON_UNUSED int __pyx_v_a_ndim, CYTHON_UNUSED npy_intp *__pyx_v_y_dims, double __pyx_v_old, double __pyx_v_new) {
  Py_ssize_t __pyx_v_i;
 ...
 */
  ...
  /* "bottleneck/nonreduce.pyx":136
 *                         (<float32_t*>((<char*>pid(ita)) + i * stride))[0] = new
 *                 PyArray_ITER_NEXT(ita)
 *     return a             # <<<<<<<<<<<<<<
 * 
 * cdef ndarray replace_int64(ndarray a, flatiter ita,
 */
  __Pyx_XDECREF(((PyObject *)__pyx_r));
  __Pyx_INCREF(((PyObject *)__pyx_v_a));
  __pyx_r = __pyx_v_a;
...
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_replace_int64(PyArrayObject *__pyx_v_a, PyArrayIterObject *__pyx_v_ita, Py_ssize_t __pyx_v_stride, Py_ssize_t __pyx_v_length, CYTHON_UNUSED int __pyx_v_a_ndim, CYTHON_UNUSED npy_intp *__pyx_v_y_dims, double __pyx_v_old, double __pyx_v_new) {
  Py_ssize_t __pyx_v_i;
 ...
 */
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 148, __pyx_L1_error)
 ...
 *             while PyArray_ITER_NOTDONE(ita):
 */
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 150, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_Raise(__pyx_t_2, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  /* "bottleneck/nonreduce.pyx":158
 *                         (<int64_t*>((<char*>pid(ita)) + i * stride))[0] = newint
 *                 PyArray_ITER_NEXT(ita)
 *     return a             # <<<<<<<<<<<<<<
 * 
 * cdef ndarray replace_int32(ndarray a, flatiter ita,
 */
  __Pyx_XDECREF(((PyObject *)__pyx_r));
  __Pyx_INCREF(((PyObject *)__pyx_v_a));
  __pyx_r = __pyx_v_a;
 ...
 */
  ...
  __Pyx_AddTraceback("bottleneck.nonreduce.replace_int64", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF((PyObject *)__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_replace_int32(PyArrayObject *__pyx_v_a, PyArrayIterObject *__pyx_v_ita, Py_ssize_t __pyx_v_stride, Py_ssize_t __pyx_v_length, CYTHON_UNUSED int __pyx_v_a_ndim, CYTHON_UNUSED npy_intp *__pyx_v_y_dims, double __pyx_v_old, double __pyx_v_new) {
  Py_ssize_t __pyx_v_i;
 ...
 *             raise ValueError("Cannot safely cast `new` to int.")
 */
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 170, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_Raise(__pyx_t_2, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *             while PyArray_ITER_NOTDONE(ita):
 */
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__4, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 172, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_Raise(__pyx_t_2, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("bottleneck.nonreduce.replace_int32", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF((PyObject *)__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyArrayObject *__pyx_f_10bottleneck_9nonreduce_nonreducer(PyObject *__pyx_v_arr, __pyx_t_10bottleneck_9nonreduce_nr_t __pyx_v_nr_float64, __pyx_t_10bottleneck_9nonreduce_nr_t __pyx_v_nr_float32, __pyx_t_10bottleneck_9nonreduce_nr_t __pyx_v_nr_int64, __pyx_t_10bottleneck_9nonreduce_nr_t __pyx_v_nr_int32, double __pyx_v_double_input_1, double __pyx_v_double_input_2, struct __pyx_opt_args_10bottleneck_9nonreduce_nonreducer *__pyx_optional_args) {
 ...
 *         if inplace == 1:
 */
    if (!(likely(((__pyx_v_arr) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_arr, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 202, __pyx_L1_error)
 ...
 */
  /*else*/ {
    __pyx_t_1 = ((__pyx_v_inplace == 1) != 0);
    if (__pyx_t_1) {

      /* "bottleneck/nonreduce.pyx":206
 *         if inplace == 1:
 *             # works in place so input must be an array, not (e.g.) a list
 *             raise TypeError             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    /*else*/ {
      __pyx_t_2 = PyArray_FROM_O(__pyx_v_arr); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 208, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __pyx_t_2 = PyArray_IterAllButAxis(((PyObject *)__pyx_v_a), (&__pyx_v_axis)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 220, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (!(likely(((__pyx_t_2) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_2, __pyx_ptype_5numpy_flatiter))))) __PYX_ERR(0, 220, __pyx_L1_error)
  __pyx_v_ita = ((PyArrayIterObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "bottleneck/nonreduce.pyx":221
 *     cdef int axis = -1
 *     cdef flatiter ita = PyArray_IterAllButAxis(a, &axis)
 *     cdef Py_ssize_t stride = PyArray_STRIDE(a, axis)             # <<<<<<<<<<<<<<
 * 
 *     # output array
 */
  __pyx_v_stride = PyArray_STRIDE(__pyx_v_a, __pyx_v_axis);

  /* "bottleneck/nonreduce.pyx":225
 *     # output array
 *     cdef ndarray y
 ...
 *     # calc
 */
  __pyx_v_length = (__pyx_v_y_dims[__pyx_v_axis]);

  /* "bottleneck/nonreduce.pyx":229
 * 
 *     # calc
 ...
 */
    __pyx_t_2 = ((PyObject *)__pyx_v_nr_float64(__pyx_v_a, __pyx_v_ita, __pyx_v_stride, __pyx_v_length, __pyx_v_a_ndim, __pyx_v_y_dims, __pyx_v_double_input_1, __pyx_v_double_input_2)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 230, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 */
    __pyx_t_2 = ((PyObject *)__pyx_v_nr_float32(__pyx_v_a, __pyx_v_ita, __pyx_v_stride, __pyx_v_length, __pyx_v_a_ndim, __pyx_v_y_dims, __pyx_v_double_input_1, __pyx_v_double_input_2)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 232, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_v_y = ((PyArrayObject *)__pyx_t_2);
    __pyx_t_2 = 0;
 ...
 */
    __pyx_t_2 = ((PyObject *)__pyx_v_nr_int64(__pyx_v_a, __pyx_v_ita, __pyx_v_stride, __pyx_v_length, __pyx_v_a_ndim, __pyx_v_y_dims, __pyx_v_double_input_1, __pyx_v_double_input_2)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 234, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_v_y = ((PyArrayObject *)__pyx_t_2);
    __pyx_t_2 = 0;
 ...
 *         raise TypeError
 */
    __pyx_t_2 = ((PyObject *)__pyx_v_nr_int32(__pyx_v_a, __pyx_v_ita, __pyx_v_stride, __pyx_v_length, __pyx_v_a_ndim, __pyx_v_y_dims, __pyx_v_double_input_1, __pyx_v_double_input_2)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 236, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_v_y = ((PyArrayObject *)__pyx_t_2);
    __pyx_t_2 = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("bottleneck.nonreduce.nonreducer", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_Replace_inplace_given_scalar_va, __pyx_k_Replace_inplace_given_scalar_va, sizeof(__pyx_k_Replace_inplace_given_scalar_va), 0, 1, 0, 0},
  {&__pyx_n_s_RuntimeError, __pyx_k_RuntimeError, sizeof(__pyx_k_RuntimeError), 0, 0, 1, 1},
  {&__pyx_n_s_TypeError, __pyx_k_TypeError, sizeof(__pyx_k_TypeError), 0, 0, 1, 1},
  {&__pyx_n_s_ValueError, __pyx_k_ValueError, sizeof(__pyx_k_ValueError), 0, 0, 1, 1},
  {&__pyx_n_s__11, __pyx_k__11, sizeof(__pyx_k__11), 0, 0, 1, 1},
  {&__pyx_n_s_arr, __pyx_k_arr, sizeof(__pyx_k_arr), 0, 0, 1, 1},
  {&__pyx_n_s_bottleneck_nonreduce, __pyx_k_bottleneck_nonreduce, sizeof(__pyx_k_bottleneck_nonreduce), 0, 0, 1, 1},
  {&__pyx_n_s_bottleneck_slow_nonreduce, __pyx_k_bottleneck_slow_nonreduce, sizeof(__pyx_k_bottleneck_slow_nonreduce), 0, 0, 1, 1},
  ...
  {&__pyx_kp_u_replace_line_36, __pyx_k_replace_line_36, sizeof(__pyx_k_replace_line_36), 0, 1, 0, 0},
 ...
 *             raise ValueError("Cannot safely cast `new` to int.")
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Cannot_safely_cast_old_to_int); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 148, __pyx_L1_error)
 ...
 *             while PyArray_ITER_NOTDONE(ita):
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_Cannot_safely_cast_new_to_int); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 150, __pyx_L1_error)
 ...
 *             raise ValueError("Cannot safely cast `new` to int.")
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_s_Cannot_safely_cast_old_to_int); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 170, __pyx_L1_error)
 ...
 *             while PyArray_ITER_NOTDONE(ita):
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_s_Cannot_safely_cast_new_to_int); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 172, __pyx_L1_error)
 ...
 *     Replace (inplace) given scalar values of an array with new values.
 */
  __pyx_tuple__12 = PyTuple_Pack(3, __pyx_n_s_arr, __pyx_n_s_old, __pyx_n_s_new); if (unlikely(!__pyx_tuple__12)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__12);
  __Pyx_GIVEREF(__pyx_tuple__12);
  __pyx_codeobj__13 = (PyObject*)__Pyx_PyCode_New(3, 0, 3, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__12, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_devel_bottleneck_bottleneck_non, __pyx_n_s_replace, 36, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__13)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_bottleneck__nonreduce) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bottleneck.nonreduce")) {
      if (unlikely(PyDict_SetItemString(modules, "bottleneck.nonreduce", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_bottleneck_slow_nonreduce, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_slow, __pyx_t_2) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     Replace (inplace) given scalar values of an array with new values.
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_10bottleneck_9nonreduce_1replace, NULL, __pyx_n_s_bottleneck_nonreduce); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_replace, __pyx_t_2) < 0) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "bottleneck/nonreduce.pyx":1
 * #cython: embedsignature=True             # <<<<<<<<<<<<<<
 * 
 * import numpy as np
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_kp_u_replace_line_36, __pyx_kp_u_Replace_inplace_given_scalar_va) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bottleneck.nonreduce", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bottleneck.nonreduce");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
